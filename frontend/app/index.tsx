  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navTab} onPress={() => router.push('/(tabs)/trip')}>
          <Text style={styles.navText}>Your Trip</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  fab: { position: 'absolute', right: 16, bottom: 80, width: 56, height: 56, backgroundColor: '#e6e1d9', borderRadius: 28, alignItems: 'center', justifyContent: 'center' },
  fabText: { color: '#0b0b0b', fontSize: 28, fontWeight: '600' },
  bigCtaBar: { position: 'absolute', left: 16, right: 16, bottom: 80 },
  ...
  navTab: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 8 },
  navText: { color: '#9aa0a6', fontSize: 14, fontWeight: '500' },
  navTextActive: { color: '#e6e1d9', fontWeight: '600' }
});