...
export const CafesPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Gradient orbs */}
      <div
        className="absolute top-0 left-1/3 w-[500px] h-[500px] rounded-full blur-[150px] pointer-events-none"
        style={{ 
      ...
      <div className="relative z-10 p-6 md:p-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            We're brewing up something special. Stay tuned!
          </p>
        </motion.div>
      </div>
    </div>
