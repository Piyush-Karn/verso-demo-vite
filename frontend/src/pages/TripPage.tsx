...
export const TripPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 bg-gray-900 text-white min-h-screen p-4">
      <div className="pt-4">
      ...
      <div className="grid gap-4">
        {mockCountries.map((c) => (
          <button
            ...
            className="relative bg-gray-800 rounded-2xl p-6 hover:bg-gray-700 transition-colors"
          >
            ...
            <div className="flex items-center gap-2 bg-yellow-400 text-gray-900 px-4 py-2 rounded-full w-fit">
              <span>✈️</span>
